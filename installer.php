...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'Naemsa_b99a32b42950ce7c2945_20241021221651_archive.zip';
        const ARCHIVE_SIZE       = '414807113';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'b99a32b-21221651';
        const SECONDARY_PACKAGE_HASH = '9a7f5a1-21221651';
